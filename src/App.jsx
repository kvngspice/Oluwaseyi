          ...
          <div className="career-sticky" id="career-sticky">
            <div className="career-track-outer">
              <div className="career-track" id="career-track" ref={trackRef}>
                ...
                <div className="career-node"><div className="cn-line"></div><div className="cn-year">Canada</div><div className="cn-role">International Chapter</div><div className="cn-place">Toronto · Canada</div><div className="cn-desc">Built a life and career on a new continent — expanding her systems, her world, her understanding of operating across cultures.</div></div>
                <div className="career-node"><div className="cn-line"></div><div className="cn-year">Now</div><div className="cn-role">Chief of Staff &amp; GM</div><div className="cn-place">Faith Leader's Office · Lagos</div><div className="cn-desc">Trusted by a high-profile faith leader and thought leader to run operations, protect his time and execute his vision. Discreet, precise, results-first.</div></div>
      ...
      <section className="builds" id="builds">
        <div className="builds-inner">
          ...
          <div className="builds-grid">
            <div className="bcard reveal d1"><div className="bc-top"><div className="bc-num">01.</div><div className="bc-name">Chief of Staff &amp; Solutions Partner</div><div className="bc-sub">Executive Operations · HNW Principals</div></div><div className="bc-body"><p>Oluwaseyi works with high-performing leaders — founders, faith leaders and executives — to protect their time, build their systems and execute their vision. Discreet, reliable, results-first.</p><a href="#contact" className="bc-link">Enquire about working together</a></div></div>
      ...
      <section className="japada" id="japada">
        <div className="japada-inner">
          <div className="reveal reveal-l">
            ...
            <p className="j-body">
              The Japada series follows a real relocation — Canada to Lagos — in honest, unfiltered episodes. Real costs. Real trade-offs. Real joy. Not a highlight reel. A blueprint.
            </p>
            <div className="j-eps">
