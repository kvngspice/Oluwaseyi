...
export default function App() {
  ...
  ` }} />
            ...
            <div className="b-cell b-4 b-bone reveal d2">
              <p className="b-bio">
        Oluwaseyi Makinde is a <strong> strategic advisor</strong> to high-profile leaders, trusted to act on their behalf with sound judgment and discretion while shielding them from unnecessary distractions and operational burdens. Her career spans four countries and three continents, with experience across organizations including Google, Amazon, the Royal Bank of Canada, the Canadian Armed Forces, Diageo, Globacom, ActionAid, among others. She is the founder of Dome, a proptech startup transforming the rental experience through technology. Through her Japada series, Oluwaseyi documents her journey of relocating from Canada to Nigeria, sharing insights on building a meaningful life back home.
              </p>
            </div>
          </div>
        </div>
...
{/* CAREER */}      <section className="career" id="career">        <div className="career-head reveal">          <span className="c-eyebrow">Career Trajectory</span>          <h2 className="c-title">          A career <span style={{ color: "var(--champ)" }}></span><br />            <em>in motion</em>          </h2>                 </div><div className="career-prog-row">              <div className="career-prog-track"><div className="career-prog-fill" id="career-fill" ref={fillRef}></div></div>              <span className="career-drag">Swipe or scroll to travel the journey</span>            </div>        <div className="career-shell" id="career-shell" ref={shellRef}>          <div className="career-sticky" id="career-sticky">            <div className="career-track-outer">              <div className="career-track" id="career-track" ref={trackRef}>
   <div className="career-node"><div className="cn-line"></div><div className="cn-year">Nigeria</div><div className="cn-role">Where it all started</div><div className="cn-place">Agency · Nigeria</div><div className="cn-desc">Born and raised in Lagos, Nigeria is where her story begins. It’s where she went to primary and secondary school, built her earliest foundations and, years later, returned to complete NYSC and begin her marketing career, managing major clients and complex campaigns as a Senior Account Manager.</div></div>                <div className="career-node"><div className="cn-line"></div><div className="cn-year">United States</div><div className="cn-role">Where independence began</div><div className="cn-desc">The U.S. gave her first real taste of independence. It’s where she began her undergraduate studies in Economics and got her first “big girl job” as an Assistant to the President of her school, the State University of New York, Buffalo. It’s where she began building the confidence and adaptability that would follow her through every move that came next.</div></div>          <div className="career-node"><div className="cn-line"></div><div className="cn-year">France </div><div className="cn-role">Where she found her lane.</div><div className="cn-desc">Next came Bordeaux, where she earned an MBA in Marketing and Brand Management at INSEEC. France sharpened her interest in brands, people and what makes an idea connect, giving her a foundation she would soon put to work back in Nigeria.</div></div>                <div className="career-node"><div className="cn-line"></div><div className="cn-year">Canada</div><div className="cn-role">Where she built</div><div className="cn-desc">Canada became home for most of her adult life. She completed her Economics degree at York University, Toronto and built a career across various industries that moved through banking, investments, marketing, learning & development while also building a business and family.</div></div>   <div className="career-node"><div className="cn-line"></div><div className="cn-year">Nigeria, again</div><div className="cn-role">Where it all comes together</div><div className="cn-desc">Eventually, she came home, this time with years of experience and a much wider view of the world. Today, as General Manager to a prominent faith leader, she works at the centre of a fast-moving world, anticipating her Principal’s needs, protecting his time and vision, resolving complex problems before they become distractions and driving priorities from idea to execution.</div></div>                <div className="career-node"><div className="cn-line"></div><div className="cn-year">Today</div><div className="cn-role">Creator &amp; Community Builder</div><div className="cn-place">@mommychoplife</div><div className="cn-desc">The Japada series documenting the return from Canada to Lagos in real time, building a community of people who share the same sentiment and also people interesting in built a functional life across boarders.</div></div>              </div>            </div>                      </div>        </div>      </section>
      {/* JAPADA */}
     {/* JAPADA */}
